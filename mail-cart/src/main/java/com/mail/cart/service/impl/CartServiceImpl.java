...
import com.mail.cart.exception.CartExceptionHandler;
import com.mail.cart.interceptor.CartInterceptor;
...
import com.mail.cart.vo.SkuInfoVo;
    ...
    public CartVo getCart() throws ExecutionException, InterruptedException {
        ...
        if (userInfoTo.getUserId() != null) {
            ...
            if (tempCartItems != null) {
                // 临时购物车有数据需要进行合并操作，
                // 合并就是将临时购物车的数据按照登录后的 userId 添加到用户的购物车，直接调用 addToCart方法即可
