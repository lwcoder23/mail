package com.mail.seckill.service.impl;
...
import com.mail.seckill.feign.CouponFeignService;
import com.mail.seckill.feign.ProductFeignService;
import com.mail.seckill.interceptor.LoginUserInterceptor;
import com.mail.seckill.service.SeckillService;
import com.mail.seckill.to.SeckillSkuRedisTo;
import com.mail.seckill.vo.SeckillSessionWithSkusVo;
import com.mail.seckill.vo.SkuInfoVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private void saveSessionInfos(List<SeckillSessionWithSkusVo> sessions) {
        ...
        sessions.stream().forEach(session -> {
            ...
            //判断Redis中是否有该信息，如果没有才进行添加，保证幂等性
